...
const toMatchSnapshot = function(received, propertyMatchers, hint) {
...
const _toMatchSnapshot = ({
  ...
  if (pass) {
    ...
    actual = utils.removeExtraLineBreaks(actual || ''); // Assign to local variable because of declaration let expected:
